...
const IMMEDIATE_GOALS = [
  ...
  },
  {
    value: 'speaking',
    emoji: '🗣️',
    label: '한국어로 간단히 대화할 수 있어요',
    sub: '할머니께 "보고 싶어요", 친척에게 인사 정도는 스스로 할 수 있으면 좋겠어요',
  },
  {
    value: 'writing',
    emoji: '✏️',
    label: '받아쓰기·짧은 글쓰기가 돼요',
    sub: '띄어쓰기, 맞춤법을 신경 쓰며 짧은 문장을 쓸 수 있어요',
  },
] as const;
